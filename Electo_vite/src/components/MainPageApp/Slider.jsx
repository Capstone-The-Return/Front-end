import img1 from "../MainPageApp/img1.jpg";
import img2 from "../MainPageApp/img2.jpg";
import img3 from "../MainPageApp/img3.jpg";

function Slider() {
  return (
    <div id="carouselExampleCaptions" className="carousel slide"style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          ...
          <div className="carousel-caption d-none d-md-block">
            ...
            <p>Unrealistic repair speed from 20' with the leading Repair Experts</p>
          </div>
        </div>
